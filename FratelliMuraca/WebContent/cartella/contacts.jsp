...
<html style="font-size: 16px;" lang="it"><head>
    ...
    <meta name="keywords" content="Sample Headline, Sample Headline, Contact Us, Sample Headline">
...
<link rel="stylesheet" href="Pagina-1.css" media="screen">
    ...
    <script type="application/ld+json">{
		...
		"@type": "Organization",
		"name": "",
		"logo": "images/Designer__6_-removebg-preview.png"
}</script>
    <meta name="theme-color" content="#478ac9">
    <meta property="og:title" content="Pagina 1">
    <meta property="og:type" content="website">
  <meta data-intl-tel-input-cdn-path="intlTelInput/"></head>
  <body data-home-page="Pagina-1.html" data-home-page-title="Pagina 1" data-path-to-root="./" data-include-products="true" class="u-body u-xl-mode" data-lang="it"><header class="u-clearfix u-header u-header" id="sec-94dc"><div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
        <a href="#" class="u-image u-logo u-image-1" data-image-width="500" data-image-height="500">
          <img src="images/Designer__6_-removebg-preview.png" class="u-logo-image u-logo-image-1">
        </a>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#" style="padding: 10px 20px;">Pagina 1</a>
</li></ul>
          </div>
...
</li><li class="u-nav-item"><a class="u-button-style u-nav-link" href="#">Pagina 1</a>
</li></ul>
              </div>
            </div>
    ...
    <section class="u-clearfix u-section-1" id="sec-40f0">
      <div class="u-clearfix u-sheet u-sheet-1">
        <img class="u-expanded-width u-image u-image-default u-image-1" src="images/Screenshot2024-06-25075306.png" alt="" data-image-width="1278" data-image-height="565">
        <h2 class="u-align-center u-text u-text-default u-text-1">CONTATTACI </h2>
        <p class="u-align-center u-text u-text-default u-text-2">Per qualsiasi dubbio siamo a disposizione </p>
      </div>
    </section>
    <section class="u-clearfix u-custom-color-2 u-section-2" id="sec-0249">
      <div class="u-clearfix u-sheet u-sheet-1">
                  ...
                  <div class="u-container-style u-layout-cell u-left-cell u-size-60 u-layout-cell-1">
                    <div class="u-container-layout u-valign-middle u-container-layout-1">
                      ...
                      <p class="u-text u-text-3">
                        <span style="font-weight: 700;"> Phone:</span>&nbsp;<a href="#" class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-bottom-left-radius-0 u-bottom-right-radius-0 u-btn u-button-link u-button-style u-hover-none u-none u-radius-0 u-text-palette-1-base u-top-left-radius-0 u-top-right-radius-0 u-btn-1">8 800 2534 236</a>
                        <br>
                        <br>
                        <span style="font-weight: 700;">Send Email:</span>&nbsp;<a href="#" class="u-active-none u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-no-left u-border-no-right u-border-no-top u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-1-base u-btn-2" data-animation-name="" data-animation-duration="0" data-animation-delay="0" data-animation-direction="">email@example.com<br>
                        </a>
                        <br>
                        <span style="font-weight: 700;">Address:</span>&nbsp;Calabria<br>
                      </p>
                      ...
                      <div class="u-expanded-width u-form u-form-1">
                        <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-spacing-10 u-form-vertical u-inner-form" source="email" name="form" style="padding: 10px;">
                          ...
                          <div class="u-align-left u-form-group u-form-submit">
                            <a href="#" class="u-btn u-btn-submit u-button-style u-custom-color-5 u-btn-3">Submit</a>
                          ...
                          <input type="hidden" name="formServices" value="3e0227c8-6d30-9570-6a9c-ac48e11706c9">
                        </form>
                      </div>
                    </div>
                  </div>
    ...
    <section class="u-clearfix u-container-align-center u-section-3" id="sec-71ce">
    ...
    <section class="u-clearfix u-container-align-center u-custom-color-5 u-section-4" id="sec-2226">
      <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
          ...
          <div class="u-layout">
            <div class="u-layout-row">
              <div class="u-container-align-center-sm u-container-align-center-xs u-container-style u-layout-cell u-size-30 u-layout-cell-1">
                <div class="u-container-layout u-valign-middle u-container-layout-1">
                  <h2 class="u-align-center-sm u-align-center-xs u-text u-text-default u-text-1">Sample Headline</h2>
                  <p class="u-align-center-sm u-align-center-xs u-text u-text-default u-text-2">Sample text. Click to select the Text Element.</p>
                </div>
              </div>
                  ...
                  <div class="u-form u-form-1">
                    <form action="https://forms.nicepagesrv.com/v2/form/process" class="u-clearfix u-form-horizontal u-form-spacing-10 u-inner-form" source="email" name="form-1" style="padding: 10px;">
                      <div class="u-form-group u-form-name u-label-none">
                        <label for="name-d89c" class="u-label">Name</label>
                        <input type="text" placeholder="Enter your Name" id="name-d89c" name="name" class="u-border-none u-input u-input-rectangle" required="" wfd-id="id762">
                      </div>
                      <div class="u-align-left u-form-group u-form-submit u-label-none">
                        <a href="#" class="u-border-none u-btn u-btn-submit u-button-style u-white u-btn-1">Submit</a>
                        <input type="submit" value="submit" class="u-form-control-hidden" wfd-id="id763">
                      </div>
                      <div class="u-form-send-message u-form-send-success"> Thank you! Your message has been sent. </div>
                      <div class="u-form-send-error u-form-send-message"> Unable to send your message. Please fix errors then try again. </div>
                      <input type="hidden" value="" name="recaptchaResponse" wfd-id="id764">
                      <input type="hidden" name="formServices" value="3e0227c8-6d30-9570-6a9c-ac48e11706c9">
                    </form>
                  </div>
                </div>
    ...
    <footer class="u-align-center u-clearfix u-footer u-grey-80 u-footer" id="sec-ae7b"><div class="u-clearfix u-sheet u-sheet-1">
