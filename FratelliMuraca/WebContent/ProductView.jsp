...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (categoria) {
        document.getElementById('productType').value = categoria;
        filterProducts(); // Perform filtering immediately
    }
    
    // Add change event listener for filter form
...
function filterProducts() {
    ...
    xhr.onreadystatechange = function() {
        if (xhr.readyState === 4 && xhr.status === 200) {
            ...
            clearProducts(); // Clear currently displayed products
